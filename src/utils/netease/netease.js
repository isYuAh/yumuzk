...
const reference = {
    ...
    g: '0CoJUm6Qyw8W8jud',
    i: 'LfRQgRsCHDsyjv9u', //随机字符串
    // h: {
    //     "encText": "5/QWLk3QlD2G9/TyuDlV5SiN7N9yJJUCVaryBNpb2eNgoOVllWTnqBw2kBjyYWbP",
    //     "encSecKey": ""
    // }
}

export function Gen(par) {
    let r = d(
        JSON.stringify(par),
        reference.e,
        reference.f,
...
function getSongUrl(ins, ids) { //AxiosInstance
    return ins.post('https://music.163.com/weapi/song/enhance/player/url/v1?csrf_token=', Gen({
        ids: ids,
        level: 'standard',
        encodeType: 'aac',
        csrf_token: ""
